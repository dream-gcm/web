...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://localhost:4000" class="icon-ON"> DREAM</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/about-the-model/">About the model</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/about-the-model/">About</a></li>
                    

                      

                      <li><a  href="http://localhost:4000/publications/">Publications &amp; communication</a></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000/science/">Science</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000/science/mjo/">MJO</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000/" title="DREAM – Hydrosphere Data and Numerics">
				<img src="http://localhost:4000/assets/img/" alt="DREAM – Hydrosphere Data and Numerics">
			</a>
      ...
      <div id="subfooter">
        <nav class="row">
          <section id="subfooter-left" class="small-12 medium-6 columns credits">
            <p>DREAM on Github and Youtube:</p>
          </section>

          <section id="subfooter-right" class="small-12 medium-6 columns">
            <ul class="inline-list social-icons">
            
              <li><a href="https://github.com/dream-gcm" target="_blank" class="icon-github" title="DREAM on github"></a></li>
            
              <li><a href="https://www.youtube.com/user/NickMJHall/featured" target="_blank" class="icon-youtube" title="Nick Hall's YouTube channel"></a></li>
